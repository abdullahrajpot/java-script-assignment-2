...
document.getElementById("concatenation").onclick = function () {
    ...
    document.getElementById("input-box").innerHTML = '<p>"Have a nice day" + " " + "Abdullah" + "!"</p>'
...
document.getElementById("login").onclick = function () {
    ...
    if (userName === "kashif" && passWord === 786) {
        ...
        document.getElementById("output-box").innerHTML = "Try using Abdullah as username and 709 as a password"
    }
